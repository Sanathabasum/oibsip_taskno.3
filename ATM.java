...
class Account 
{
    ...
    public void credentialCheck(String U,String P,int i,int n)
    {
...
public class ATM
{
	...
	System.out.print("\n\nEnter Number of users you want to register:");
	int n=sc.nextInt(); 
